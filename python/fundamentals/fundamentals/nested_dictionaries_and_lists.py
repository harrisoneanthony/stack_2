...
# Create a function printInfo(some_dict) that given a dictionary whose values are all lists, prints the 
# name of each key along with the size of its list, and then prints the associated values within each 
# key's list.
